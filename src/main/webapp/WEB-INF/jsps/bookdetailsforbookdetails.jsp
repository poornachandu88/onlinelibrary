  ...
  <thead>
	...
	<%
		try {
			...
			out.print("<thead class="+"tabhead"+"><tr class="+"tr"+"><th class="+"th"+">ID</th><th class="+"th"+">BOOKNAME</th><th class="+"th"+">AUTHOR</th></tr></thead>");
			while (rs.next()) {
							
				out.print("<tbody>");

				out.print("<td class="+"th"+">" + rs.getString(1) + "</td>");
				out.print("<td class="+"th"+">" + rs.getString(2) + "</td>");
				out.print("<td class="+"th"+">" + rs.getString(3) + "</td>");
				out.print("</tbody>");
			}}
