 ...
 <div class="adminlogin">
	...
	<c:if test="${UserClickBooks==true}">
		...
		<%@include file="./page.jsp"%>
	 	...
	 	<form name=F1 onSubmit="return dil(this)" action="/onlinelibrary2/onlinelibrary2/admin1" method="post">
	     <fieldset>
 			   
				  <%if(request.getAttribute("aaa")!=null)
			{
			out.print("<div>");
			out.print("<font color='blue'><font size='3'>"+request.getAttribute("aaa")+"");
      ...
      <input type="text" class="form-control" id="exampleInputPassword1"  name="username" required="required"/>
    </div>
    <div class="form-group">
